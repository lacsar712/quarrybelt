...
function renderSnapshot(snap) {
  ...
  document.getElementById("pressure").textContent = snap.yard.steam_pressure_psi.toFixed(0);
  document.getElementById("mw").textContent = snap.yard.output_mw.toFixed(1);
  document.getElementById("scale-level").textContent = snap.scale.level_percent.toFixed(1);
  document.getElementById("burner").textContent = snap.beltbank.burner_phase;
  document.getElementById("o2").textContent = snap.beltbank.excess_o2_pct.toFixed(2);
  trendData.push(snap.yard.steam_pressure_psi);
...
document.getElementById("btn-beltprep").addEventListener("click", () => postAction("/beltprep/start?holder=hmi"));
document.getElementById("btn-beltprep-done").addEventListener("click", () => postAction("/beltprep/complete?holder=hmi"));
