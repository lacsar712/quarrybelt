...
const (
	EvStartBeltprep     PlantEvent = "start_beltprep"
	EvBeltprepComplete  PlantEvent = "beltprep_complete"
...
func StateLabel(s model.PlantState) string {
	...
	case model.StateColdStandby:
		return "Cold Standby"
	case model.StateBeltprep:
		return "Chute Beltprep"
...
func EventLabel(e PlantEvent) string {
	switch e {
	case EvStartBeltprep:
		return "Start Beltprep"
	case EvBeltprepComplete:
		return "Beltprep Complete"
	case EvIgnite:
		return "Ignite"
